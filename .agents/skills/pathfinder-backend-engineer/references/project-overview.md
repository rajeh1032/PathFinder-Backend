...
- Orchestrate AI features through OpenAI.
...
- RAG-backed answers using Supabase pgvector and OpenAI embeddings.

Current code state: OpenAI config exists in `src/config/openai.js`, but AI services and prompt files are empty placeholders.
